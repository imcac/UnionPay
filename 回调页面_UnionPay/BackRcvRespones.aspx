<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BackRcvRespones.aspx.cs" Inherits="UnionPay_BackRcvRespones" %>
        ...
        <table border="1">
            <%
                ...
                if (Request.HttpMethod == "POST")
                {
                    ...
                    Response.Write("<p>" + Newtonsoft.Json.JsonConvert.SerializeObject(resData) + "</p>");
